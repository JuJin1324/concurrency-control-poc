...
### 1. 전략적 추론: "고독한 수호자(The Lone Warrior)"의 가치
본 실험을 통해 우리는 **"비관적 락은 DB 성벽 안에서 홀로 정합성을 수수하는 고독한 전사"**와 같다는 아키텍처적 통찰을 얻었으며, 이는 향후 유사 시나리오에서도 핵심적인 설계 원칙이 될 것으로 예상됩니다.
- **관찰:** 낙관적 락이 외부의 도움(재시도 로직 등) 없이는 고경합 상황에서 무력하게 무너지는 것과 달리, 비관적 락은 DB 엔진의 힘만으로 모든 요청을 완벽하게 완수했습니다.
- **경험적 체득:** 복잡한 비즈니스 로직이 얽힌 전투에서는, 여러 기술을 조합하는 것보다 강력한 한 명의 전사(비관적 락)가 성문을 꽉 쥐고 있는 것이 훨씬 단순하고 확실한 전략임을 증명했습니다.
