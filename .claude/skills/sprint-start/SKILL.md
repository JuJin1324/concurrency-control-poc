...
│   │   ├── iteration-1-summary.md  # Iteration 1 완료 요약
│   │   ├── iteration-2-summary.md  # Iteration 2 완료 요약
...
│   ├── 3. 구현
│   ├── 4. 검증
│   └── 5. 📄 Summary 생성 (iteration-N-summary.md)
├── Iteration 2: {목표}
│   └── ...
└── Iteration N: 통합 및 문서화
```

### Iteration Summary 파일 (필수)

> **터미널 환경의 한계 극복:** 스크롤해서 작업 내역을 따라가기 어려우므로, 각 Iteration 완료 시 summary 파일 생성

**파일 경로:** `.agile/sprints/sprint-N/iteration-M-summary.md`

**생성 시점:** 각 Iteration의 모든 태스크 완료 후, 다음 Iteration 시작 전
...
**Iteration:** Iteration {M} - {Iteration Goal}
**완료일:** {날짜}
...
**최종 업데이트:** 2026-01-24
**변경 사항:**
- v2.1.0: Iteration Summary 파일 생성 기능 추가 (Sprint 1 회고 반영)
  - 각 Iteration 완료 시 `iteration-N-summary.md` 파일 생성 필수
  - 사용자 피드백 섹션 추가 (코드/아키텍처 수정 요청 가능)
  - 터미널 환경의 한계 극복 (스크롤 추적 어려움 해결)
- v2.0.0: agile-sprint를 3개의 독립 스킬로 분리 (sprint-start, sprint-status, sprint-complete)
