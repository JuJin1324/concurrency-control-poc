...
**최종 업데이트:** 2026-02-02
**변경 사항:**
- **Merge:** `concurrency-control-poc` (v2.1.0)과 `problem-solving` (v2.1.0) 스킬 통합
- **Feat:** Iteration Summary 기능 표준화 (모든 프로젝트 적용)
- **Feat:** 유연한 문서 경로 지원 (루트 또는 `docs/planning/` 자동 탐색)