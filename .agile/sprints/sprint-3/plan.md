...
#### US-3.11: 대규모 시나리오 실행
- [x] **Step 1: High Load (VU 1,000 / 재고 1,000)**
  - 4가지 방식 모두 실행
- [x] **Step 2: Extreme Load (VU 5,000 / 재고 10,000)**
  - 4가지 방식 모두 실행
...
- [x] `docs/performance-test-result.md` 업데이트
...
- [x] k6 스트레스 테스트 스크립트 작성
- [x] VU 1,000 / 5,000 테스트 실행
- [x] Max TPS 및 병목 구간 분석
- [x] 성능 리포트 v2 업데이트
