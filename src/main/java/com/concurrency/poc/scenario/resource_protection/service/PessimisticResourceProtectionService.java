...
@Slf4j
public class PessimisticResourceProtectionService implements ResourceProtectionService {
    ...
    public void process(Long stockId, int amount) {
        log.debug("Pessimistic Resource Protection - Attempting to decrease stock: {}", stockId);
